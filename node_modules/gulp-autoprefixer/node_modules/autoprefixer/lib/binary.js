(function() {
  ...
  Binary = (function() {
    ...
    Binary.prototype.parseArguments = function() {
      var arg, args, _base, _base1, _base2, _base3;
      ...
      while (args.length > 0) {
        ...
        switch (arg) {
          ...
          case '-I':
          case '--inline-map':
            (_base = this.processOptions).map || (_base.map = {});
            this.processOptions.map.inline = true;
            break;
          case '--annotation':
            (_base1 = this.processOptions).map || (_base1.map = {});
            this.processOptions.map.annotation = args.shift();
            break;
          case '--no-map-annotation':
            (_base2 = this.processOptions).map || (_base2.map = {});
            this.processOptions.map.annotation = false;
            break;
          case '--sources-content':
            (_base3 = this.processOptions).map || (_base3.map = {});
      ...
      if (output === '-') {
        ...
        return fs.outputFile(output, result.css, (function(_this) {
          return function(error) {
            ...
            if (result.map) {
              map = ((_ref1 = opts.map) != null ? _ref1.annotation : void 0) ? path.resolve(path.dirname(output), opts.map.annotation) : output + '.map';
              return fs.writeFile(map, result.map, function(error) {
                if (error) {
                  _this.error("autoprefixer: " + error);
                }
